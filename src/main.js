...
// ✅ GitHub Pages subpath 대응 (ex: /crime-scene-site/)
...
const SUSPECTS = [
  {
    ...
    name: "목사님",
    desc: "청년부 담당 교역자",
    img: `${BASE}assets/images/pastor.jpg`,
    questions: [
...
if (bgm) {
  // ✅ HTML에 src가 있든 없든, 여기서 확실히 세팅 (GitHub Pages 경로 문제 방지)
  bgm.src = `${BASE}assets/audio/bgm.mp3`;
  bgm.loop = true;
  bgm.preload = "auto";
}
